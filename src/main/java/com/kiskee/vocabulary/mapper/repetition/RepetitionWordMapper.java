...
public interface RepetitionWordMapper {
    ...
    @Mappings({
            @Mapping(target = "word", source = "repetitionData.currentWord.word"),
            @Mapping(target = "wordHint", source = "repetitionData.currentWord.wordHint")
    })
    ...
    WSResponse toWSResponse(RepetitionData repetitionData, boolean previousAnswerIsCorrect);
}
