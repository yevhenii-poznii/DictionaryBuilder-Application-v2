...
public class YearlyRepetitionStatisticReportRowServiceTest {

    @InjectMocks
    private YearlyRepetitionStatisticReportRowService yearlyRepetitionStatisticReportRowService;
    ...
    void
        ...
        RepetitionStatisticReportRow yearlyRow =
                yearlyRepetitionStatisticReportRowService.buildRowFromScratch(testData.data());
    ...
    void testUpdateRow_WhenRowExistsForTodayAndGivenDictionaryReportExists_ThenRecalculateRow(TestData testData) {
        ...
        YearlyRepetitionStatisticReportRow yearlyRowForToday = YearlyRepetitionStatisticReportRow.builder()
                .id(1L)
        ...
        RepetitionStatisticReportRow yearlyRow =
                yearlyRepetitionStatisticReportRowService.updateRow(yearlyRowForToday, testData.data());
    ...
    void testUpdateRow_WhenRowExistsForPreviousDayAndCurrentDateInTheSamePeriod_ThenRecalculateRowForNewDay(
        ...
        assertThat(yearlyRow.getEndPeriod()).isEqualTo(testData.data().getCurrentDate());
        assertThat(yearlyRow.getDictionaryReports()).containsExactlyInAnyOrder(testData.expectedDictionaryReport());
    }
