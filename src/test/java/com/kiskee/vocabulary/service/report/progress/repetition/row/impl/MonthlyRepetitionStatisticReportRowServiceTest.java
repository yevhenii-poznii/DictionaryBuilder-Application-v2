...
public class MonthlyRepetitionStatisticReportRowServiceTest {

    @InjectMocks
    private MonthlyRepetitionStatisticReportRowService monthlyRepetitionStatisticReportRowService;
    ...
    void
            testBuildRowFromScratch_WhenMonthlyRowDoesNotExistAndUserWasCreatedBeforeReportStartPeriod_ThenBuildRowFromScratchWithStartPeriod(
                    TestData testData) {
        RepetitionStatisticReportRow monthlyRow =
                monthlyRepetitionStatisticReportRowService.buildRowFromScratch(testData.data());
        ...
        assertThat(monthlyRow.getDictionaryReports()).containsExactly(testData.expectedDictionaryReport());
    }
    ...
    void testUpdateRow_WhenRowExistsForTodayAndGivenDictionaryReportExists_ThenRecalculateRow(TestData testData) {
        ...
        MonthlyRepetitionStatisticReportRow monthlyRowForToday = MonthlyRepetitionStatisticReportRow.builder()
                .id(1L)
        ...
        RepetitionStatisticReportRow monthlyRow =
                monthlyRepetitionStatisticReportRowService.updateRow(monthlyRowForToday, testData.data());
    ...
    void testUpdateRow_WhenRowExistsForPreviousDayAndCurrentDateInTheSamePeriod_ThenRecalculateRowForNewDay(
        ...
        assertThat(monthlyRow.getEndPeriod()).isEqualTo(testData.data().getCurrentDate());
        assertThat(monthlyRow.getDictionaryReports()).containsExactlyInAnyOrder(testData.expectedDictionaryReport());
    }
