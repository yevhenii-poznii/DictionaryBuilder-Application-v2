...
public class DictionaryPageLoaderOnlyUseInRepetitionDESCTest {
    ...
    @Test
    void testGetPageFilter_WhenDictionaryPageLoaderOnlyUseInRepetitionDESC_ThenReturnPageFilterONLY_USE_IN_REPETITION_DESC() {
    ...
    void testLoadDictionaryPage_WhenGivenValidDictionaryIdAndPageRequest_ThenReturnDictionaryPageResponseDto() {
        ...
        DictionaryPageResponseDto result = dictionaryPageLoaderOnlyUseInRepetitionDESC.loadDictionaryPage(dictionaryId, pageRequest);
