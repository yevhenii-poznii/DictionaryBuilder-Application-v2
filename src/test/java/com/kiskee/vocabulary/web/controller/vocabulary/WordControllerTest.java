...
public class WordControllerTest {
    ...
    void testAdd_WhenDictionaryExistsForUserAndGivenValidWordSaveRequest_ThenAddNewWord() {
        ...
        WordSaveRequest saveRequest = new WordSaveRequest(word, List.of(
                new WordTranslationDto(null, "переклад"),
                new WordTranslationDto(null, "переклад")
        ), "hint");
        ...
        WordSaveResponse expectedResponse = new WordSaveResponse(
                ...
                new WordDto(1L, word, true, List.of(
                        new WordTranslationDto(1L, "переклад"),
                        new WordTranslationDto(2L, "переклад")),
                        "hint")
        );
    ...
    void testUpdate_WhenDictionaryExistsForUserAndGivenValidWordUpdateRequest_ThenUpdateExistingWord() {
        ...
        WordUpdateRequest updateRequest = new WordUpdateRequest(word, false, List.of(
                new WordTranslationDto(1L, "перекладдд"),
                new WordTranslationDto(2L, "перекладд")
        ), "hinthint");

        WordSaveResponse expectedResponse = new WordSaveResponse(
                String.format(VocabularyResponseMessageEnum.WORD_UPDATED.getResponseMessage(), word),
                new WordDto(10L, word, false, List.of(
                        new WordTranslationDto(1L, "перекладдд"),
                        new WordTranslationDto(2L, "перекладд")),
                        "hinthint")
        );
    ...
    void testUpdate_WhenWordDoesNotExistForDictionary_ThenReturnForbiddenStatus() {
        ...
        when(wordService.updateWord(dictionaryId, wordId, updateRequest))
                .thenThrow(new ForbiddenAccessException(String.format(ExceptionStatusesEnum.FORBIDDEN_ACCESS.getStatus(),
        ...
        mockMvc.perform(put("/dictionaries/{dictionaryId}/words/{wordId}", dictionaryId, wordId)
                ...
                .andExpectAll(
                        ...
                        jsonPath("$.errors.responseMessage")
                                .value("You have no access to Word [10]"));
    }
    ...
    void testDelete_WhenDictionaryAndWordExistForUser_ThenDeleteWord() {
        ...
        mockMvc.perform(delete("/dictionaries/{dictionaryId}/words/{wordId}", dictionaryId, wordId))
                ...
                .andExpectAll(
                        status().isOk(),
                        jsonPath("$.responseMessage").value(responseMessage.getResponseMessage()));
    }
    ...
    static Stream<WordUpdateRequest> invalidWordUpdateRequest() {
        return Stream.of(
                ...
                new WordUpdateRequest("word123", true, List.of(
                        new WordTranslationDto(null, "translation")), "hint")
        );
    }
    ...
    static Stream<WordSaveRequest> invalidWordSaveRequest() {
        return Stream.of(
                ...
                new WordSaveRequest("word123", List.of(new WordTranslationDto(null, "translation")),
                        "hint")
        );
    }
