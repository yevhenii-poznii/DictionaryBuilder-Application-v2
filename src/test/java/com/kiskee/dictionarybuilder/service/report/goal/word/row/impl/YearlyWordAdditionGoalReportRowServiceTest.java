...
public class YearlyWordAdditionGoalReportRowServiceTest {
    ...
    void testUpdateRow_WhenYearlyRowExistsAndGivenAddedWordsNegative_ThenRecalculateRow(TestData testData) {
        DictionaryWordAdditionGoalReport dictionaryGoalReport =
                new DictionaryWordAdditionGoalReport(1L, 5L, DICTIONARY_NAME, 70.0, 50, 35);
        YearlyWordAdditionGoalReportRow yearlyRow = YearlyWordAdditionGoalReportRow.builder()
                .id(1L)
                .startPeriod(testData.data().getCurrentDate().minusDays(5))
                .endPeriod(testData.data().getCurrentDate())
                .workingDays(5)
        ...
        WordAdditionGoalReportRow updatedYearlyRow =
                yearlyWordAdditionGoalReportRowService.updateRow(yearlyRow, testData.data());

        assertThat(yearlyRow.getWorkingDays()).isEqualTo(5);
        assertThat(yearlyRow.getRowPeriod()).isEqualTo(ReportPeriodUtil.YEAR);
        assertThat(yearlyRow.getStartPeriod())
                .isEqualTo(testData.data().getCurrentDate().minusDays(5));
        assertThat(updatedYearlyRow.getEndPeriod()).isEqualTo(testData.data().getCurrentDate());
        assertThat(updatedYearlyRow.getDictionaryReports())
